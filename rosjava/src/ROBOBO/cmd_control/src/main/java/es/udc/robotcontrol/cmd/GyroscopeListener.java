...
public class GyroscopeListener implements NodeMain {
    ...
    public static void main(String args[]) {
        if (args.length < 1){
            System.err.println("java GyroscopeListener <robotName>");
            System.exit(1);
        }

        try {
            NodeMainExecutor ex = DefaultNodeMainExecutor.newDefault();
            new GyroscopeListener(args[0], ex);
    ...
    public GyroscopeListener(String robotName, NodeMainExecutor nodeMainExecutor) {
        super();
    ...
    public GraphName getDefaultNodeName() {
        return GraphName.of("GyroscopeListener");
    }
    ...
    public void onStart(ConnectedNode connectedNode) {
        ...
        String topicName = "/" + robotName + "/" + Constants.TOPIC_GYROSCOPE;
    ...
    public void onError(Node node, Throwable throwable) {
        System.out.println("Error on Gyroscope Listener [ " + node.getName() + " ] [ " + throwable.getMessage() + " ]");
    }
