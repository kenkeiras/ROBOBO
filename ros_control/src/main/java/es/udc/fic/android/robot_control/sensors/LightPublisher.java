...
public class LightPublisher extends AbstractSensorsPublisher {

    private static String QUEUE_NAME = Constantes.TOPIC_LIGHT;

    public LightPublisher(Context ctx, String robotName) {
        super(ctx, robotName);
    }
